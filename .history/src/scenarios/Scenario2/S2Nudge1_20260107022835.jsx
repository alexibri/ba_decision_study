            ...
            <div className="s2innerCard">
                ...
                <div className="s2cardHeader">
                    ...
                    <div className="s2accountRow">
                        <div className="s2label">Enable Notifications to stay informed about security issues and suspicious activity</div>
                    </div>
                </div>
                <div className="s2popUp">
                    ...
                    <button className="s2accept" onClick={() => navigate("/scenario/2/step/2")}>
                        Enable security notifications Continue without notifications
                    </button>
                    </div>
