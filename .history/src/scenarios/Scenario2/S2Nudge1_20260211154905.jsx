...
export default function S2Dark1() {
    const {handleChoice} = useResponseTracker(5);
        ...
        <div className="s2card">
            ...
            <div className="s2innerCard">
                ...
                <div className="s2popUp">
                    ...
                    <button className="s2accept" onClick={() => {handleChoice("disable_notifications",{ to:"/scenario/2/step/2", replace:false})}}>
                        Continue without notifications
                    </button>
                    </div>

                    <div className="s2button">
                    <button className="s2accept" onClick={() =>  {handleChoice("enable_notifications",{ to:"/scenario/2/step/2", replace:false})}}>
