    ...
    return <div className="s1screen fade-in">
        ...
        <div className="s1card">
            ...
            <div className="s1button">
                <button className="s1accept" onClick={() => {handleChoice("accept_all",{ to:"/scenario/1/step/2", replace:false)}}> await handleChoice("confirm_delete_account", { to: "/end", replace: true });
                    Accept all
                </button>
            </div>
            <div>
                <button className="s1decline" onClick={() => {handleChoice("decline_all","/scenario/1/step/2")}}>
                    Decline all
                </button>
            </div>
