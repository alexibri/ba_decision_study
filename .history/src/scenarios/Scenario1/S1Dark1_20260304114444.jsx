...
export default function S1Dark1() {
    ...
    const { handleChoice, loading } = useResponseTracker(s1Dark);
    ...
    return <div className="s1screen fade-in">
        ...
        <div className="s1card">
            ...
            <div className="s1button">
                <button className="s1accept" disabled={loading} onClick={() => { handleChoice("accept_all", { to: "/scenario/1/step/2", replace: true }) }}>
                    Accept all cookies
                </button>
            </div>
            ...
            <br /><br />
            <div className="s1button">
                <button className="s1acceptEssential" disabled={loading} onClick={() => { handleChoice("accept_essential", { to: "/scenario/1/step/2", replace: true }) }}>
                    Accept essential cookies
                </button>
            </div>

            <div className="s1button">
                <button className="s1decline" disabled={loading} onClick={() => { handleChoice("decline_all", { to: "/scenario/1/step/2", replace: true }) }}>
                    Decline all cookies
                </button>
            </div>
            <br />
