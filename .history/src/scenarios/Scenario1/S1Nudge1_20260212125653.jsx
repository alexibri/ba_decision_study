    ...
    return <div className="s1screen fade-in">
        ...
        <div className="s1card">
            ...
            <p>
                ...
                These keep you logged in, remember your cart,    │ │
│  │ and ensure a secure connection. They do NOT track you across sites.
            </p>

            <div className="s1button">
                <button className="s1accept" onClick={() => {handleChoice("accept_essentials",{ to:"/scenario/1/step/2", replace:true})}}>
                    Accept essentials (Recommended)
                </button>
            </div>
