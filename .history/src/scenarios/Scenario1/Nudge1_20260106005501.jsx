...
export default function Nudge1() {
    ...
    return <div className="s1screen">
        ...
        <div className="s1card">
            ...
            <div className="s1button">
                <button className="s1accept" onClick={() => navigate("/scenario/1/nudge2")}>
                    Accept all
                </button>
            </div>
            ...
            <div className="s1scroll">
                ...
                <button className="s1termsAndConditions" onClick={() => navigate("/scenario/1/nudge2")}>
