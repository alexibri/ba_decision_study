...
export default function S1Nudge1() {
    //screen_id: 2 = S1Nudge
    const { handleChoice, loading } = useResponseTracker(2);
    ...
    return <div className="s1screen fade-in">
        ...
        <div className="s1card">
            ...
            <p>
                ...
                These keep you logged in and ensure a secure connection. They do NOT track you across sites.
            </p>
            ...
            <div className="s1button">
                <button className="s1accept" disabled={loading} onClick={() => { handleChoice("decline_all", { to: "/scenario/1/step/2", replace: true }) }}>
