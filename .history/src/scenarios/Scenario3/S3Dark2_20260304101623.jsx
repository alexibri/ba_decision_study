...
export default function S3Dark2() {
    ...
    const onConfirm = async () => {
        const await handleChoice("confirm_delete_account", { to: "/end", replace: true });
            ...
            <div className="s3innerCard">
                ...
                <div className="s3popUp">
                    ...
                    <div className="s3buttonPopUp">
                        <button className="s3decision" onClick={onCancel}>
                            Cancel
                        </button>
                    </div>

                    <div className="s3buttonPopUp">
                        <button className="s3decision" onClick={onConfirm}>
                            Continue
                        </button>
                    </div>
