            ...
            <div className="s3innerCard">
                ...
                <div className="s3popUp">
                    ...
                    <div className="s3buttonPopUp">
                        <button className="s3accept" onClick={() => { handleChoice("cancel_delete_account", "/end"); updateCurrentRun() }}>
                            Cancel
                        </button>
                    </div>

                    <div className="s3buttonPopUp">
                        <button className="s3accept" onClick={() => { handleChoice("confirm_delete_account", "/end"); updateCurrentRun() }}>
                            Continue
                        </button>
                    </div>
