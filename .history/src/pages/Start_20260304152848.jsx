...
export default function Start() {
    ...
    const STUDY_GROUP = import.meta.env.VITE_STUDY_GROUP // "dark" oder "nudge"
                ...
                <div className="startCard">
                    ...
                    <div className="stack">
                        <div className="startPopUpButton">
                            <button className="startStudyButton" disabled={loading} onClick={() => startWithDesign({ currentDesignStrategy: 1, groupName: "dark" })}>
                                Start
                            </button>
                        </div>
                    </div>
