...
export default function Start() {
    ...
    const STUDY_GROUP = import.meta.env.VITE_STUDY_GROUP
                ...
                <div className="startCard">
                    ...
                    <div className="stack">
                        <div className="startPopUpButton">
                            <button className="startStudyButton" disabled={loading} onClick={() => startWithDesign({ currentDesignStrategy:DESIGN_STRATEGY STUDY_GROUP, groupName: DESIGN_STRATEGY })}>
                                Start
                            </button>
                        </div>
                    </div>
