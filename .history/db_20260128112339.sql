CREATE TABLE partici (
    partici_ID number(10),
    partici_emailAdress VARCHAR(20),

    CONSTRAINT pk_partici_ID      PRIMARY KEY (partici_ID),
);
...
CREATE TABLE Session(
    ...
    CONSTRAINT fk_session_partici_ID            FOREIGN KEY (partici_ID)     REFERENCES Study(study_ID),
