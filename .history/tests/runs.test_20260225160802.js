...
describe("runs.createRun", () => {
    ...
    it("inserts payload and returns run_id", async() => {
        ...
        const response = await createRun( { runStatus: "started", designStrategyID: 1})
        ...
        expect(response).toEqual({run_id: 99})
    ...
    it("returns null on insert error", async() => {
        ...
        builder.single.mockRejectedValueOnce({data: {run_id: 1}, error})
    })
})