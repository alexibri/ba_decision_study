...
CREATE TABLE IF NOT EXISTS run(
    ...
    run_status VARCHAR(40) NOT NULL
        CHECK (LOWER(run_status) IN ('started','finished','aborted')), --DEFAULT
...
INSERT INTO TABLE screen (7,"S2Nudge1");
INSERT INTO TABLE screen (8,"S2Transition"); 
INSERT INTO TABLE screen (9,"S3Dark1");
INSERT INTO TABLE screen (10,"S3Dark2");
INSERT INTO TABLE screen (11,"S3Nudge1");
INSERT INTO TABLE screen (12,"S3Nudge2");
INSERT INTO TABLE screen (13,"S3Transition");
