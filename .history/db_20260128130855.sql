...
(
    ...
    _ID BIGSERIAL,
    study_session
    _startAt TIMESTAMPTZ NOT NULL DEFAULT now(),
    study_session
    _endAt TIMESTAMPTZ,
    participant_ID BIGINT NOT NULL ,
    design_strategy_id BIGINT NOT NULL ,

    CONSTRAINT pk_study_session
    _ID      PRIMARY KEY (study_session
    _ID),
    CONSTRAINT fk_study_session
    _participant_ID            FOREIGN KEY (participant_ID)     REFERENCES Participant(participant_ID) ON DELETE CASCADE,
    CONSTRAINT fk_study_session
    _design_strategy_id            FOREIGN KEY (design_strategy_id)     REFERENCES designstrategy(design_strategy_id)
);
...
CREATE TABLE Response(
    ...
    CONSTRAINT fk_response_study_session
    _ID            FOREIGN KEY (study_session
    _ID)     REFERENCES study_session
    (study_session
