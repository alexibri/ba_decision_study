...
CREATE TABLE DesignStrategy(
    ...
    study_ID number(10) NOT NULL ON DELETE CASCADE,
...
CREATE TABLE StudySession(
    ...
    participant_ID number(10) NOT NULL ON DELETE CASCADE,
    designStrategy_ID number(10) NOT NULL ON DELETE RESTRICT,
...
CREATE TABLE Screen(
    ...
    UNIQUE (study_ID,screen_orderIndex)
)
...
CREATE TABLE Button(
    ...
    screen_ID number(10) CREATE TABLE Participant (
    participant_ID number(10),
    participant_emailAdress VARCHAR(100),
...
CREATE TABLE DesignStrategy(
    ...
    UNIQUE(study_ID,designStrategy_name)
    CONSTRAINT pk_designStrategy_ID      PRIMARY KEY (designStrategy_ID),
    CONSTRAINT fk_designStrategy_study_ID            FOREIGN KEY (study_ID)     REFERENCES Study(study_ID)
) 
...
CREATE TABLE Button(
    ...
    button_key VARCHAR(100) NOT NULL
    button_orderIndex INT,
    screen_ID number(10) ON DELETE CASCADE,
