...
CREATE TABLE participant (
    ...
    CONSTRAINT fk_study_id            FOREIGN KEY (study_id)     REFERENCES study(study_id)  ON DELETE CASCADE --Das auch dann raus
)
...
CREATE TABLE response_screen(
    ...
    CONSTRAINT ak_response_screen_id  UNIQUE(response_id,screen_id)          ALTERNATIVE KEY (screen_id)     REFERENCES screen(screen_id),
);
