...
CREATE TABLE Response(
    ...
    CONSTRAINT fk_response_screen_ID            FOREIGN KEY (session_ID)     REFERENCES Session(session_ID),
    CONSTRAINT fk_response_button_ID            FOREIGN KEY (session_ID)     REFERENCES Session(session_ID),
)
