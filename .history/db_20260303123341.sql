...
CREATE TABLE IF NOT EXISTS screen (
    ...
    CONSTRAINT fk_screen_design_strategy_id FOREIGN KEY (design_strategy_id) REFERENCES design_strategy (design_strategy_id)
);
...
CREATE TABLE IF NOT EXISTS response (
    response_id SERIAL,
    response_reaction_time_ms INT CHECK (response_rtms >= 0),
