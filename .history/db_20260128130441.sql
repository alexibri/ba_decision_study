...
CREATE TABLE design(
    ...
    CONSTRAINT fk_design_study_ID            FOREIGN KEY (study_ID)     REFERENCES Study(study_ID)  ON DELETE CASCADE
) ;
...
CREATE TABLE StudySession(
    ...
    CONSTRAINT fk_studySession_design_ID            FOREIGN KEY (design_ID)     REFERENCES design(design_ID) ON DELETE RESTRICT
);
