...
CREATE TABLE study_session(
    ...
    design_strategy_id BIGINT NOT NULL , --Macht keinen Sinn. Design Strategy müsste auch rübergehen zu Study
    response_id BIGINT NOTNULL,
    ...
    CONSTRAINT fk_study_session_response_id            FOREIGN KEY (response_id)     REFERENCES response(response_id) ON DELETE CASCADE
);

CREATE TABLE design_strategy(
    design_strategy_id BIGSERIAL,
    design_strategy_name VARCHAR(100) NOT NULL,
    study_id BIGINT NOT NULL, --Hmm es gibt mehrere Designstrategien. Aber für jede Session nur eine. Aber ne Studie kann mehrere haben 
