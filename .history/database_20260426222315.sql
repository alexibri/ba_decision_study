...
CREATE TABLE IF NOT EXISTS screen (
    ...
    CONSTRAINT uk_screen_name UNIQUE (design_strategy_name)
);
...
CREATE UNIQUE INDEX uniq_run_user_finished 
    ON run (user_id)
    WHERE run_status = 'finished';

CREATE UNIQUE INDEX uniq_run_user_started 
    ON run (user_id, design_strategy_id)
