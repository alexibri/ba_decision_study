CREATE TABLE participant (
    participant_ BIGSERIAL,
    participant_email_adress VARCHAR(100),

    CONSTRAINT pk_participant_      PRIMARY KEY (participant_)
);
...
CREATE TABLE study_session(
    ...
    participant_ BIGINT NOT NULL ,
    design_strategy_id BIGINT NOT NULL ,

    CONSTRAINT pk_study_session_id      PRIMARY KEY (study_session_id),
    CONSTRAINT fk_study_session_participant_            FOREIGN KEY (participant_)     REFERENCES participant(participant_) ON DELETE CASCADE,
