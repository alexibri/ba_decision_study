...
CREATE POLICY "Public can read design strategies" 
...
INSERT INTO design_strategy (design_strategy_name) VALUES('Dark Pattern'),
    ('Nudge');

INSERT INTO screen (screen_name,design_strategy_id) VALUES
    ('S1Dark'),
    ('S1Nudge'),
    ('S2Dark'),
    ('S2Nudge'),
