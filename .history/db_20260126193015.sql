...
CREATE TABLE Study(
    ...
    CONSTRAINT fk_study_designStrategy_ID            FOREIGN KEY (designStrategy_ID)     REFERENCES Condition(designStrategy_ID)
);
...
CREATE TABLE DesignStrategy(
    ...
    CONSTRAINT fk_condition_study_ID            FOREIGN KEY (study_ID)     REFERENCES Study(study_ID)
)
...
CREATE TABLE Session(
    ...
    CONSTRAINT fk_session_user_ID            FOREIGN KEY (user_ID)     REFERENCES Study(study_ID),
    CONSTRAINT fk_session_condition_ID            FOREIGN KEY (study_ID)     REFERENCES Study(study_ID)
